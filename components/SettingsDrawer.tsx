...
export default function SettingsDrawer({ isOpen, onClose }: SettingsDrawerProps) {
    ...
    // Settings content shared between both layouts
                ...
                <div className="space-y-2">
                    {BG_PRESETS.map((preset) => (
                        <motion.button
                            ...
                            className={`
                                w-full flex items-center gap-3 p-3 rounded-2xl min-h-[44px]
                ...
                <div className="grid grid-cols-2 gap-2">
                    {[
                        ...
                        <button
                            ...
                            className={`
                                flex items-center gap-2 py-2.5 px-3 rounded-xl text-sm font-medium min-h-[44px]
                    ...
                    {isMobile ? (
                        ...
                        <motion.aside
                            ...
                            style={{
                                ...
                                boxShadow: "0 -20px 60px rgba(0,0,0,0.8), 0 -1px 0 rgba(255,255,255,0.1)",
                            }}
                            initial={{ y: "100%" }}
                            animate={{ y: 0 }}
                            exit={{ y: "100%" }}
